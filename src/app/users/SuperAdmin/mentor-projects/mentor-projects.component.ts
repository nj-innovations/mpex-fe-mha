...
export class MentorProjectsComponent implements OnInit {
	@Input() mentorProjects: SuperAdminUserMentorProject[] = [];
	@Input() user_id = 0;
	faFilePen = faFilePen;
	...
	updateMentorProject(project: SuperAdminUserMentorProject){
	...
	deleteMentorProject(project: SuperAdminUserMentorProject){
